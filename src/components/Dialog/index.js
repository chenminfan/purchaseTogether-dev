...
export default function DialogComponents(props) {
  const { open, handleClose, dialogRef, fullScreen, maxWidth, fullWidth, children, dialogTitle, handleSubmit, dialogSubmitBtnText, dialogSubmitColor, theme, color } = props;
