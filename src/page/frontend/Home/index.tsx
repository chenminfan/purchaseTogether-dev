...
const Home = () => {
  ...
  return (
    <div className='home_page'>
      ...
      <section className={`home-section ${windowHeight > 100 ? 'is-show' : ''}`}>
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12">
      ...
      <section className={`home-section home-section-color ${windowHeight > 890 ? 'is-show' : ''}`}>
      ...
      <section className={`home-section home-section-imgBox ${windowHeight > 1400 ? 'is-show' : ''}`}>
        {boxImageText.map((imageinfo, index) => (
      ...
      <section className={`home-section home-section-color ${windowHeight > 2300 ? 'is-show' : ''}`}>
        <div className="home-box bg-body-secondary">
          <div className="box col-10">
            <h4>
              <div className="box-title">
